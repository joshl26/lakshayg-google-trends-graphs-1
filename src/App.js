...
const App = ({
  ...
  const data =
    result.length == 0 || result.length == 1 ? [[1, 1, 1, 1]] : result;
  const options = {
  ...
  const options2 = ["Line Chart", "Scatter Chart"];
          ...
          <div className="col-md-10 col-sm-12">
            <div style={{ textAlign: "center" }}>
              <textarea
                ...
                placeholder="Trend 1 keywords"
                onChange={handleTrend1}
              ></textarea>
              <textarea
                style={{ margin: "10px", width: "30%" }}
                placeholder="Trend 2 keywords"
                onChange={handleTrend2}
              ></textarea>
            </div>
            <div style={{ textAlign: "center" }}>
              <button
            ...
            <div style={{ textAlign: "center", margin: "20px" }}>
              {sending ? (
                <img src={loading} />
              ) : result.length == 1 && result[0] && result[0].length ? (
